...
public class IndexSender implements ISender {
    ...
    private void level2RowData(MysqlRowData rowData) {
        ...
        if (rowData.getTableName().equals(Constant.AD_PLAN_TABLE_INFO.TABLE_NAME)) {
            ...
            // 将增量数据的索引读进内存中
            planTables.forEach(p -> AdLevelDataHandler.handleLevel2(p, rowData.getType()));
            ...
            creativeTables.forEach(c ->
                    AdLevelDataHandler.handleLevel2(c, rowData.getType()));
        }
    ...
    private void level3RowData(MysqlRowData rowData) {
        ...
        if (rowData.getTableName().equals(Constant.AD_UNIT_TABLE_INFO.TABLE_NAME)) {
            ...
            creativeUnitTables.forEach(cu ->
                    AdLevelDataHandler.handleLevel3(cu, rowData.getType()));
        }
    }
        ...
        switch (rowData.getTableName()) {
            case Constant.AD_UNIT_DISTRICT_TABLE_INFO.TABLE_NAME:
                ...
                districtTables.forEach(d ->
                        AdLevelDataHandler.handleLevel4(d, rowData.getType()));
                break;
            ...
            case Constant.AD_UNIT_IT_TABLE_INFO.TABLE_NAME:
                ...
                itTables.forEach(i ->
                        AdLevelDataHandler.handleLevel4(i, rowData.getType()));
                break;
            ...
            case Constant.AD_UNIT_KEYWORD_TABLE_INFO.TABLE_NAME:
                ...
                keywordTables.forEach(k ->
                        AdLevelDataHandler.handleLevel4(k, rowData.getType()));
                break;
        }
    }
}
